...
handle_clear: // PB0 pressed
	BL read_slider_switches_ASM // Keep polling switches
	BL write_LEDs_ASM           // And update LEDs accordingly
...
do_operation:
	...
	B poll_buttons              // Go back to polling
...
hex_to_bcd:
	...
	hex_to_bcd_loop:
		...
		CMP V2, #16               // Once index = 16, we have shifted all the 17 bits, so break
		BEQ hex_to_bcd_end
		...
		B hex_to_bcd_loop         // Branch to next iteration
